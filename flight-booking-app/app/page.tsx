    ...
    <div className="flex flex-col w-full max-w-2xl pt-12 pb-24 mx-auto stretch">
      ...
      {messages.length === 0 && (
        <div className="mb-8 space-y-4">
          ...
          <Suggestions>
            <Suggestion
              suggestion="Find me flights from San Francisco to Los Angeles"
              onClick={(suggestion) =>
                sendMessage({
                  text: suggestion,
            ...
            />
            <Suggestion
              suggestion="What's the status of flight UA123?"
              onClick={(suggestion) =>
                sendMessage({
                  text: suggestion,
                  metadata: { createdAt: Date.now() },
            ...
            />
            <Suggestion
              suggestion="Tell me about SFO airport"
              onClick={(suggestion) =>
                sendMessage({
                  text: suggestion,
                  metadata: { createdAt: Date.now() },
            ...
            />
            <Suggestion
              suggestion="What's the baggage allowance for United Airlines economy?"
              onClick={(suggestion) =>
                sendMessage({
                  text: suggestion,
                  metadata: { createdAt: Date.now() },
            ...
            />
            <Suggestion
              suggestion="Book a flight from New York to Miami"
              onClick={(suggestion) =>
                sendMessage({
                  text: suggestion,
                  metadata: { createdAt: Date.now() },
